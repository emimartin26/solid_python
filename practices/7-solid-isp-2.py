...
class PaymentMethodCreditCard(PaymentMethod):
    @abstractmethod
    def show_card_info(self):
        pass 


class CreditCard(PaymentMethodCreditCard):
    @staticmethod
...
class DebitCard(PaymentMethodCreditCard):
    @staticmethod
    def meets_condition(raw_data):
...
class PaymentManager:
    ...
    def identify_payment(self):
        for payment_method_cls in [PaymentMethod.__subclasses__()[1] ,*PaymentMethodCreditCard.__subclasses__()]:
